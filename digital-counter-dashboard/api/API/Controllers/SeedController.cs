...
namespace API.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public SeedController(ApplicationDbContext context, RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<ActionResult> CreateDefaultUsers()
        {
            ...
            if (await _userManager.FindByNameAsync(email_Admin) == null)
            {
                ...
                await _userManager.CreateAsync(user_Admin, "admin");
            ...
            if (await _userManager.FindByNameAsync(email_User) == null)
            {
                ...
                await _userManager.CreateAsync(user_User, "user");
