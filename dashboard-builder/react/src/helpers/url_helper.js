...
// ApiLists
export const GET_REACT_APILISTS = "/ApiLists/GetReactTable";
export const GET_APILIST = "/ApiLists/GetApiList";
export const UPDATE_APILIST = "/ApiLists/UpdateApiList";
export const CREATE_APILIST = "/ApiLists/CreateApiList";
export const DELETE_APILIST = "/ApiLists/DeleteApiList";
export const POST_API_LOGIN_LOGIN = "/Account/Login";
