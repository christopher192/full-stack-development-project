...
// ApiLists
export const getReactApiLists = (params) => api.getReactTable(url.GET_REACT_APILISTS, params);
export const getApiList = (id) => api.get(url.GET_APILIST, id);
export const deleteApiList = (apiList) => api.deleteById(url.DELETE_APILIST, apiList);
export const addNewApiList = (apiList) => api.create(url.CREATE_APILIST, apiList);
export const updateApiList = (apiList) => api.put(url.UPDATE_APILIST, apiList);
export const postAPILogin = (data) => api.create(url.POST_API_LOGIN_LOGIN, data);
