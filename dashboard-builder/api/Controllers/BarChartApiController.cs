...
using static API.Controllers.BarChartApiController;
...
namespace API.Controllers
{
    ...
    [ApiController]
    public class BarChartApiController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetBarChartApiFirst")]
        public JsonResult GetBarChartApiFirst()
        {
        ...
        [HttpGet]
        [Route("GetBarChartApiSecond")]
        public JsonResult GetBarChartApiSecond()
        {
            var jsonData = new JSONData();
        ...
        [HttpGet]
        [Route("GetBarChartApiThird")]
        public JsonResult GetBarChartApiThird()
        {
            var jsonData = new JSONData();
        ...
        [HttpGet]
        [Route("GetBarChartApiForth")]
        public JsonResult GetBarChartApiForth()
        {
            var jsonData = new JSONData();
        ...
        [HttpGet]
        [Route("GetBarChartApiFifth")]
        public JsonResult GetBarChartApiFifth()
        {
            var jsonData = new JSONData();
