...
namespace WD_ERECORD_CORE.Pages.User
{
    ...
    public class SystemAdminPageModel : UserManagementPageModel
    {
        private readonly ApplicationDbContext _context;
        private UserManager<ApplicationUser> _userManager { get; set; }
        private RoleManager<IdentityRole> _roleManager { get; set; }

        public SystemAdminPageModel(ApplicationDbContext context, UserManager<ApplicationUser> mgr, RoleManager<IdentityRole> roleMgr)
        {
            _context = context;
            _userManager = mgr;
