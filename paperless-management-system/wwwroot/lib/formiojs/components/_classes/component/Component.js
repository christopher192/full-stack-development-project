...
var Component = /*#__PURE__*/function (_Element) {
  ...
  _createClass(Component, [{
    ...
    value: function calculateComponentValue(data, flags, row) {
      ...
      if (this.options.readOnly && !this.options.pdf || !this.component.calculateValue || shouldBeCleared || this.options.server && !this.component.calculateServer || flags.dataSourceInitialLoading && allowOverride) {
        return false;
      }
    ...
    value: function shouldSkipValidation(data, dirty, row) {
      ...
      function () {
        return _this17.component.validate.custom && !_this17.dataValue && !_this17.component.validate.required;
