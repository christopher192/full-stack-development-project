...
var ColumnsComponent = /*#__PURE__*/function (_NestedComponent) {
  ...
  _createClass(ColumnsComponent, [{
    ...
    value: function init() {
      ...
      if (this.component.autoAdjust && ((_this$root = this.root) === null || _this$root === void 0 ? void 0 : _this$root.schema.display) !== 'pdf') {
        this.justify();
      }
    ...
    value: function checkData(data, flags, row, components) {
      ...
      if (this.component.autoAdjust && ((_this$root2 = this.root) === null || _this$root2 === void 0 ? void 0 : _this$root2.schema.display) !== 'pdf') {
