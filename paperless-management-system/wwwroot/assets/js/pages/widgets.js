...
var KTWidgets = function () {
    ...
    var _initChartsWidgetDummy = function () {
        var element = document.getElementById("kt_charts_widget_dummy_chart");
        ...
        var options = {
            series: [
                {
                    name: 'SMT First Article Inspection Checklist',
                    data: [55, 30, 40, 40, 90, 90, 70, 70, 85, 65, 33, 48]
                },
                {
                    name: 'Depanel Conversion Checklist',
                    data: [33, 45, 32, 22, 26, 33, 45, 36, 30, 44, 21, 23]
                },
                {
                    name: 'Router Conversion Checklist',
                    data: [47, 31, 56, 34, 38, 49, 22, 45, 56, 22, 35, 48]
                },
                {
                    name: 'Packing Room Conversion Checklist',
                    data: [23, 15, 23, 33, 23, 43, 46, 33, 23, 36, 12, 32]
                },
                {
                    name: '5S and maintenance Checklist For Zebra Printer',
                    data: [55, 34, 39, 67, 54, 58, 61, 51, 44, 65, 37, 45]
                },
            ],
            chart: {
                type: 'line',
    ...
    var _initChartsWidgetDummy2 = function () {
        var element = document.getElementById("kt_charts_widget_dummy2_chart");
        ...
        var options = {
            ...
            labels: ['SMT First Article Inspection Checklist', 'Depanel Conversion Checklist', 'Router Conversion Checklist', 'Packing Room Conversion Checklist', '5S and maintenance Checklist For Zebra Printer'],
            title: {
                text: 'Today Submission',
                align: 'left'
            },
            legend: {
                show: false
    ...
    return {
        init: function () {
            ...
            _initChartsWidget2();
            _initChartsWidget3();
            _initChartsWidgetDummy();
            _initChartsWidgetDummy2();
            _initChartsWidget4();
            _initChartsWidget5();
            _initChartsWidget6();
            _initChartsWidget7();
