...
{
    public class MasterFormCCBApprover
    {
        [Key]
        ...
        public int? MasterFormCCBApprovalLevelId { get; set; }

        public virtual MasterFormCCBApprovalLevel? MasterFormCCBApprovalLevel { get; set; }
    }
}
